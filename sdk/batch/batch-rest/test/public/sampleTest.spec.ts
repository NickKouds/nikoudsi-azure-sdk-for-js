 ...
 */
import { BatchGeneratedClient, BatchPoolOutput, JobAddParameters, JobUpdateParameters, PoolAddParameters, PoolPatchParameters } from "../../src/generated/";
...
describe("Batch Test", () => {
  ...
  describe("Basic Pool operations", () => {
    ...
    //   const listResult = await batchClient.path("/pools").get();

    //   assert.isDefined(listResult.body?.values.length)
