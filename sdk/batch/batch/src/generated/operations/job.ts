...
const listFromJobScheduleOperationSpec: coreClient.OperationSpec = {
...
const listPreparationAndReleaseTaskStatusOperationSpec: coreClient.OperationSpec = {
...
const getTaskCountsOperationSpec: coreClient.OperationSpec = {
...
const listFromJobScheduleNextOperationSpec: coreClient.OperationSpec = {
  path: "{nextLink}",
  httpMethod: "GET",
  responses: {
    200: {
...
const listPreparationAndReleaseTaskStatusNextOperationSpec: coreClient.OperationSpec = {
  path: "{nextLink}",
  httpMethod: "GET",
  responses: {
    200: {
